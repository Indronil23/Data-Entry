...
layout = [
    ...
    [sg.Text('Code Number', size=(15, 1)), sg.InputText(key='Code Number')],
...
while True:
    ...
    if event == 'Clear':
        clear_input(values)
    if event == 'Submit':
        # Convert checkbox boolean values to strings
        for key in ['German', 'Spanish', 'English']:
            values[key] = 'Yes' if values[key] else 'No'
